...
## 🆕 **Latest Release: v1.2.1 - Improved Folder Structure & Organization**
**Release Date:** July 13, 2025

### 🗂️ **Major Improvements:**
- **Renamed `.wau` → `.woaru` folder** - Better brand consistency and clarity
- **Centralized Review Reports** - All review files now saved in `.woaru/` directory
- **Improved File Organization** - Backup files use `.woaru-backup-*` naming convention
- **Enhanced Developer Experience** - Cleaner project structure with organized WOARU files

### 🔧 **Technical Changes:**
- Updated all file paths and references throughout the codebase
- Modified StateManager, FileWatcher, and all Action classes
- Enhanced CLI to automatically create `.woaru` directory
- Improved backup file naming and restoration processes
